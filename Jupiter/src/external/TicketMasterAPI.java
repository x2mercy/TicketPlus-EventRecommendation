...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "niGlv7V8apQ4Vh8kIWyEoNMCxSy8MqTl";
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//send request to ticketmaster and get response, reponse code cound be returned directly
			...
			in.close();
			JSONObject obj = new JSONObject(reponse.toString());
